...
const FarmerSignup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:5000/signup/farmer', submitDate);
                ...
                <div className="w-full max-w-4xl bg-white rounded-lg shadow-xl overflow-hidden flex flex-col md:flex-row">
                    ...
                    <div className="md:w-2/5 bg-gradient-to-br from-green-700 to-green-600 p-12 text-white flex flex-col justify-center relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-green-100 mb-6">Connect directly with farmers and access fresh, quality produce for your business.</p>
                    ...
                    <div className="md:w-3/5 p-12 bg-white">
                        <div className="flex justify-between items-center mb-8">
                            <h3 className="text-2xl font-semibold text-gray-800">Create Farmer Account</h3>
